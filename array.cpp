...
//pass by refrence -> it means that the change we do is actually doing changes in actual value not in copy
//pass by value -> it mean that we make a copy and do changes in it ,not in actual value
// in array while we use function we use pass by refrence which make changes in actual value not in copy
